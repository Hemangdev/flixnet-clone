                ...
                <div className='fixed w-full px-4 py-24 z-50'>
                    <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
                        <div className='max-w-[320px] mx-auto py-16'>
                            ...
                            {error ? <p className='bg-red-500 px-3 py-2 rounded-md text-white font-semibold mt-3'>{error}</p> : null}
                            <form onSubmit={handleFormSubmit} className='w-full flex flex-col py-4'>
                                ...
                                <button className=' bg-red-600 text-white py-3 my-6 font-bold rounded'>Sign In</button>
                                ...
                                <Link to= '/SignUp' > 
                                <p className='py-3'>
                                    <span className='text-gray-600'>New to FLixNet? </span>
                                    Sign Up
                                </p>
                                </Link>
                            </form>
